...
const text = `Abhinandh & Athira are getting married and having a reception on 20 December 2026 at 4:00 PM onwards at ${VENUE}. Join us in celebrating their special day! ${window.location.href}`;
    const urls = {
