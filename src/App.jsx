...
function App() {
  ...
  const share = (network) => {
    ...
    if (network !== "instagram") window.open(urls[network], "_blank", "noopener,noreferrer");
  };
    ...
    <div className="reference-site">
      ...
      <main>
        ...
        <section className="reference-section couple-block" id="couple">
          ...
          <img className="couple-photo" src="/file_00000000439482119f44e5b05ff8ace3.png" alt="Athira and Abhinandh together" />
          ...
          <div className="couple-cards">
            <article>
              <div>
                ...
                <span>With a gentle heart and a smile that makes every room feel like home.</span>
              </div>
            </article>
            ...
            <article>
              <div>
                ...
                <span>With a heart full of love, she turns the simplest moments into celebrations.</span>
              </div>
            </article>
          </div>
        </section>
