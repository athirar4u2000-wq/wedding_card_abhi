...
function App() {
  ...
  return (
    <div className="reference-site">
      ...
      <main>
        <section className="reference-hero" id="top">
          ...
          <div className="hero-copy">
            ...
            Reception on <p></p><div className="hero-meta"><p> 20 December 2026</p> 4:00 PM onwards<p>{VENUE}</p></div>
          </div>
      ...
      <footer className="reference-footer"><p>With Blessings From Our Families</p><h2><strong><em>Abhinandh </em></strong> <i className="love-symbol">♡</i> <strong><em>Athira</em></strong></h2><p>Reception on 20 December 2026 4.00 PM</p><small>{VENUE}</small><div>Made with love · <strong><em>Abhinandh</em></strong> &amp; <strong><em>Athira</em></strong> · 2026</div></footer>
